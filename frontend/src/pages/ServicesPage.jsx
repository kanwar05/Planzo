    ...
    <>
      ...
      <section className="section-pad container-shell">
        <div className="grid gap-7 md:grid-cols-2 lg:grid-cols-3">
          {services.map(({ title, slug, description, icon: Icon, image }, index) => (
