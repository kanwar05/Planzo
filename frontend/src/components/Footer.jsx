      ...
      <div className="container-shell grid gap-12 py-16 md:grid-cols-2 lg:grid-cols-4">
        <div className="lg:col-span-2">
          ...
          <p className="mt-5 max-w-sm text-sm leading-7 text-white/55">
            Thoughtful vendors, transparent choices, and celebrations that feel
            unmistakably yours.
          </p>
          <div className="mt-6 flex gap-3">
            {[Instagram, Linkedin, Mail].map((Icon, index) => (
              <a
                key={index}
                href="#"
                className="grid h-10 w-10 place-items-center rounded-full bg-white/8 text-white/70 transition hover:bg-coral hover:text-white"
              >
